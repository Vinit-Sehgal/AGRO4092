...
1) Global surface soil moisture 

2) Normalized Difference Vegetation Index (NDVI) 

Global surface soil moisture: NASA's Soil Moisture Active Passive (SMAP) satellite[@entekhabi2009]

Moderate Resolution Imaging Spectroradiometer (MODIS) instrument onboard the Terra and Aqua satellites [@huete1999modis]
...
Coupled Model Intercomparison Project (CMIP) project [@iturbide2020]
