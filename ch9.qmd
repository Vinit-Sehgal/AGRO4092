...
![](images/clipboard-1143469546.png){width="550"}
...
> <!-- -->
> ```
> 3.  Use `tryCatch` **carefully** as it may suppress legitimate errors as well, generating spurious results. Test the codes for smaller region without `tryCatch` to test the robustness of your codes.
...
Due to sifficient availability of moisture in humid and sub-humid climates, an increase in temperature is matched with a corresponding increase in evapotranspiration (hence, positive correlation).
In contrast, in arid and semi-arid regions, general scarcity of moisture restricts cooling of the surface by evaporation or transpiration.
