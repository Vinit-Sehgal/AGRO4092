...
We will also transform global aridity raster to a polygon using `as.polygons` and `st_as_sf` functions to find the mean soil moisture values for each aridity class.
