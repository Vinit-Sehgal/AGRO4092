...
sm=rast("./SampleData-master/SMAP_rasters/SMAP_L3_SM_P_20210513_R17030_001_Soil_Moisture_Retrieval_Data_AM_soil_moisture_d159ccb8.tif")
...
Let us now observe SMAP rasters from three consecutive days.
Notice that these rasters are patchy.
...
In the case of SMAP satellite, it takes 2-3 days to cover the entire planet.
Let us observe the swaths and dynamics of SMAP soil moisture observations for three consecutive days:

```{r, message = FALSE, warning = FALSE}

SMday1=rast("./SampleData-master/SMAP_rasters/SMAP_L3_SM_P_20210513_R17030_001_Soil_Moisture_Retrieval_Data_AM_soil_moisture_d159ccb8.tif")

SMday2=rast("./SampleData-master/SMAP_rasters/SMAP_L3_SM_P_20210514_R17030_001_Soil_Moisture_Retrieval_Data_AM_soil_moisture_d30c6810.tif")

SMday3=rast("./SampleData-master/SMAP_rasters/SMAP_L3_SM_P_20210515_R17030_001_Soil_Moisture_Retrieval_Data_AM_soil_moisture_d4a60938.tif")

layout(matrix(1:3, ncol = 3))                # Specify layout
plot(SMday1, main="day1")
plot(SMday2, main="day2")
plot(SMday3, main="day3")
```
...
layout(matrix(1:3, ncol = 3))                # Specify layout
plot(SMday1, main="day1, filtered")
plot(SMday2, main="day2, filtered")
plot(SMday3, main="day3, filtered")
```

Lets now calculate the average soil moisture for the three days of observation.
