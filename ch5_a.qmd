...
For this chapter, we will use Aridity index (AI), which is a popular metric for climate classification based on the relative availability of Mean Annual Precipitation (***P***) compared to the Mean Annual Reference Evapotranspiration (***ET~0~***) of a location.
...
![Global Climate Classification Map Based on Aridity Index](images/clipboard-1114277511.png){fig-align="left" width="600"}

For the purpose of this demonstration, we will use CONUS-wide raster of aridity index estimates (i.e. P/ET~0~) provided by [@zomer2022version], at \~0.8X0.8 KM spatial resolution.
